...
export default function Title500() {
    return (
        <Head>
            ...
            <title>500: internal server error | inovativy</title>
            ...
            <meta name="keywords" content="500, internal server error, inovativy, Portfolio,broken link ,missing page,link not found" />
