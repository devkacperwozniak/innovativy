...
export default function TitleArticles() {
    return (
        <Head>
            ...
            <title>Articles by inovativy</title>
            <meta name="description" content="Explore articles authored by inovativy, a Full Stack Engineer and Developer." />
