...
export default function TitleArticles() {
    return (
        <Head>
            ...
            <title>Articles by Innovativy</title>
            <meta name="description" content="Explore articles authored by Innovativy, a Full Stack Engineer and Developer." />
